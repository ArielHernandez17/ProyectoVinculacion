-- =======================================================
-- init.sql - Esquema de base de datos para incidencias_db
-- =======================================================
...
-- Tabla de roles (Admin, Revisor, Usuario)
...
-- Tabla de edificios (ej. A1, A2, Lab1, etc.)
CREATE TABLE IF NOT EXISTS edificios (
    id INT AUTO_INCREMENT PRIMARY KEY,
    nombre VARCHAR(100) NOT NULL UNIQUE
);

-- Tabla de salones (pertenecen a un edificio)
...
-- Edificios predefinidos (12 aulas + 4 laboratorios)
INSERT INTO edificios (nombre) VALUES 
('A1'), ('A2'), ('A3'), ('A4'), ('A5'), ('A6'), ('A7'), ('A8'), ('A9'), ('A10'), ('A11'), ('A12'),
('Lab1'), ('Lab2'), ('Lab3'), ('Lab4');

-- Salones para A1 (3 pisos * 5 salones = 15)
...
-- ========== MEJORAS AVANZADAS (aplicadas después de creación inicial) ==========

-- Agregar columna para almacenar ruta de imagen (subida con multer)
ALTER TABLE incidencias ADD COLUMN imagen_path VARCHAR(255) NULL AFTER comentario;

-- Tabla para historial de cambios de estado (tracking)
...
-- Índice para búsquedas rápidas por incidencia en el historial
